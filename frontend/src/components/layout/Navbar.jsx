          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-12">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`relative px-4 py-2 rounded-xl text-base font-semibold font-body transition-all duration-300 ${location.pathname === link.path
                  ? 'text-candy'
            ...
            <div className="px-4 py-4 space-y-1">
              {navLinks.map((link, i) => (
                ...
                >
                  <Link
                    to={link.path}
                    className={`block px-4 py-3 rounded-xl font-semibold font-body transition-all ${location.pathname === link.path
